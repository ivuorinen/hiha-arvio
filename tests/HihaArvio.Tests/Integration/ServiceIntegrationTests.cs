...
public class ServiceIntegrationTests : IDisposable
{
    ...
    /// <summary>
    /// Verifies that an estimate generated by EstimateService can be saved and retrieved from StorageService.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Verifies that saving more estimates than the configured limit prunes history to the maximum size.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Verifies that loading settings from storage and using the saved mode produces an estimate with the correct mode.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Verifies that shake detection data is correctly passed through to the generated estimate.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Verifies that a shake duration exceeding 15 seconds triggers the humorous mode easter egg.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Verifies that low and high intensity shakes both produce valid estimates from their respective ranges.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Verifies the full end-to-end flow from shake detection through estimate generation to storage persistence.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Verifies that multiple shake-estimate-save cycles accumulate history entries in newest-first order.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Verifies that changing the selected mode in settings causes subsequent estimates to use the new mode.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Verifies that the ShakeDataChanged event triggers estimate generation and storage when a shake is detected.
    /// </summary>
    [Fact]
